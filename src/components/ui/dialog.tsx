...
>(({ className, children, hideDefaultClose, fullScreenMobile, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    <DialogPrimitive.Content
      ...
      className={cn(
        "fixed z-[1000] flex flex-col w-full border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%]",
        fullScreenMobile 
          ? "!left-0 !top-0 !translate-x-0 !translate-y-0 !max-w-none !h-full !inset-0 !rounded-none lg:!left-[50%] lg:!top-[50%] lg:!translate-x-[-50%] lg:!translate-y-[-50%] lg:h-auto lg:w-auto lg:max-w-lg lg:rounded-lg"
          : "left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] max-w-lg sm:rounded-lg",
        className,
      )}
      {...props}
    >
