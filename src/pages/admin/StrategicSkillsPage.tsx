...
import StrategicSkillsManagementPage from "./StrategicSkillsManagement";

const StrategicSkillsPage = () => {
  return (
    <AdminLayout>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-1 text-sm md:text-base max-w-2xl">
              Curate and manage the core competencies that define your unique approach and professional value.
            </p>
          </div>
...
export default StrategicSkillsPage;
