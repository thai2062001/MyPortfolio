  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-2xl bg-stone-100 transition-all duration-500 md:duration-1000 ease-[0.22,1,0.36,1] border border-white/40 md:group-hover:shadow-[0_60px_120px_-30px_rgba(0,0,0,0.15)] md:group-hover:-translate-y-3 transform-gpu backface-hidden" style={{ WebkitMaskImage: '-webkit-radial-gradient(white, black)' }}>
        <div className="relative aspect-[4/5] auto overflow-hidden bg-muted transform-gpu" style={{ WebkitMaskImage: '-webkit-radial-gradient(white, black)' }}>
          <img
          ...
          <div className="absolute inset-x-4 bottom-4 md:inset-x-6 md:bottom-6 z-10 transition-transform duration-500 md:duration-700 ease-out md:group-hover:translate-y-[-0.5rem]">
            <div className="ethereal-glass bg-white/95 md:bg-white/60 backdrop-blur-sm md:backdrop-blur-xl rounded-xl p-5 md:p-6 lg:p-8 space-y-3 lg:space-y-4 shadow-[0_12px_24px_rgba(0,0,0,0.12)] md:shadow-[0_20px_40px_rgba(0,0,0,0.15)] md:group-hover:border-sage/40 transition-colors duration-500 md:duration-700 transform-gpu">
              <div className="space-y-3 lg:space-y-4">
                 <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2 overflow-hidden">
                      ...
                      <p className="font-artistic text-[14px] md:text-[16px] lg:text-[20px] text-vibe-pink">
                        {category_name || "Project"}
                      </p>
                    </div>
                 </div>
                 
                 <h3 className="font-display text-xl sm:text-2xl md:text-2xl lg:text-3xl xl:text-4xl text-heading leading-tight tracking-tight">
                    {mainTitle}{" "}
                    {lastWord && (
              ...
              <div className="opacity-100 transition-all duration-500 ease-in-out overflow-hidden block">
                <div className="overflow-hidden">
                  <div className="pt-1.5 pb-1.5 space-y-4 lg:space-y-5">
                     {short_description && (
                       <p className="font-body text-[13px] md:text-[14px] text-heading line-clamp-2 max-w-[95%] font-semibold leading-relaxed">
                          {short_description}
                       </p>
                     )}
                     
                      <div className="flex items-center gap-4 text-sage group/cta cursor-pointer">
                         <span className="font-display lg:font-sans text-[11px] md:text-[12px] lg:text-[10px] tracking-[0.2em] lg:tracking-[0.3em] uppercase font-bold lg:font-extrabold">Discover</span>
