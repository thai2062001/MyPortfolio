    ...
    >
      ...
      >
        <img 
          ...
          loading="lazy"
          className="w-full h-full object-cover transition-transform duration-500 md:duration-[1.5s] ease-out md:group-hover:scale-110 will-change-transform"
        />
      ...
      <div className="p-8 md:p-10 flex flex-col flex-grow space-y-6">
        ...
        <div className="space-y-4 flex-grow">
           <h3 
             className="text-2xl md:text-3xl font-serif text-heading font-medium leading-[1.2] tracking-tight md:hover:text-sage transition-colors cursor-pointer md:group-hover:underline decoration-sage/20 underline-offset-8 break-words"
            onClick={() => navigate(`/blog/${post.slug}`)}
          >
            {localization.title}
          </h3>
        ...
        <div className="pt-4 flex items-center justify-between border-t border-stone-50">
          ...
          >
            ...
            <div className="w-8 h-8 rounded-full border border-stone-100 flex items-center justify-center md:group-hover/btn:bg-sage md:group-hover/btn:text-white md:group-hover/btn:border-sage transition-all duration-500">
               <ArrowUpRight size={14} className="md:group-hover/btn:rotate-45 transition-transform" />
            </div>
          </button>
        </div>
      </div>
